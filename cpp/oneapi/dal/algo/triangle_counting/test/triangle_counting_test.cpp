...
public:
    ...
    std::array<std::int32_t, 3> degrees = { 1, 1, 1 };
...
public:
    ...
    void check_triangle_counting(const GraphType &my_graph,
...
TEST_M(triangle_counting_test, "check triangle counting in a complete graph") {
    complete_graph_type complete_graph;
    const auto my_complete_graph = create_graph<complete_graph_type>();
    this->check_triangle_counting(my_complete_graph,
